...
app.get('/carrello', (req, res) => {
  const token = 'il-tuo-token-jwt'; // Sostituisci con il tuo token JWT

  // Effettua una richiesta GET all'endpoint del microservizio utenti attraverso l'API Gateway
